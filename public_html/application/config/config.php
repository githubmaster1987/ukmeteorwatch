...
|
| Generate a hash from the following website:
| https://www.grc.com/passwords.htm
|
*/
$config['encryption_key'] = 'MaXOwb8i7ZE6A6WO2PlOmWO1AXxyzToNPAkd948pBj3CD5T0NR3sD65wbv61HeN';
...
$config['sess_cookie_name']		= 'ukmon_session';
$config['sess_expiration']		= 86400; // 24*60*60 24 hours
