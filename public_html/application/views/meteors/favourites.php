...
<div class="tabbable"> <!-- Only required for left/right tabs -->
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?= site_url('meteors/favourites') ?>" >Favourites</a></li>
        <li><a href="<?= site_url('meteors/combined') ?>">Combined view</a></li>
    </ul>

    <div class="tab-content">

        <div class="tab-pane active liveimage_container" id="tab2">
            <?=$images?>
    ...
    $(function(){
		...
		function insert_images($data)
		{
			$.ajax({
				cache: false,
				type: 'get',
				url: '<?php echo site_url('meteors/favourites'); ?>',
				success: function(data)
				{
